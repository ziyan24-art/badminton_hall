          ...
          <div class="card-body ">
            <form method="POST" action="{{ route('register') }}">
              ...
              <div class="input-group {{ $errors->has('name') ? ' has-danger' : '' }}">
                ...
                <input class="form-control {{ $errors->has('name') ? ' is-invalid' : '' }}" placeholder="{{ __('Name') }}" type="text" name="name" value="{{ old('name') }}" autocomplete="off" required autofocus>
              ...
              <div class="input-group {{ $errors->has('email') ? ' has-danger' : '' }}">
                ...
                <input class="form-control{{ $errors->has('email') ? ' is-invalid' : '' }}" placeholder="{{ __('Email') }}" type="email" name="email"  required>
              </div>
              @if ($errors->has('email'))
              <span class="invalid-feedback" style="display: block;" role="alert">
