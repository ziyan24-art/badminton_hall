...
<div class="mt-20 h-full align-middle flex justify-center items-center flex-col">
    <div class="bg-white shadow-xl px-4 py-4 rounded-lg w-full md:max-w-sm">
        ...
        <form action="{{ route('login') }}" method="post" id="formLogin" autocomplete="off">
            @csrf
            <div class="mb-3">
                <label>Email</label>
                <input type="email" class="bg-gray-100" name="email" placeholder="Email Anda" autocomplete="new-email">
            </div>
            <div class="mb-3">
                <div class="flex justify-between mb-2">
                    <label>Password</label>
                </div>
                <input type="password" class="bg-gray-100" name="password" placeholder="Password" autocomplete="new-password">
            </div>
            <div class="mb-3">
