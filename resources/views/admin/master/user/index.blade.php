            ...
            <div class="modal-body">
                <form action="" method="post" id="editForm">
                    ...
                    <p class="alert alert-danger alert-dismissible fade show" role="alert">
                        <i class="fas fa-info-circle"></i> Isi formulir dibawah jika ingin mengubah password, jika tidak kosongkan semua kolom password
                    ...
                    <div class="form-group">
                        ...
                        <input type="password" name="password" placeholder="Ganti Password" class="form-control" autocomplete="new-password">
                    </div>
                    <div class="form-group">
    ...
    $(document).ready(function() {
        ...
        $('.btn-delete').click(function() {
            ...
            confirmDelete('Apakah Anda yakin ingin menghapus User?', function() {
                $.ajax({
                    url: `/admin/master/user/delete/${id}`, // sesuaikan jika beda
                    type: 'DELETE',
                    dataType: 'json',
                    data: {
                        _token: token
