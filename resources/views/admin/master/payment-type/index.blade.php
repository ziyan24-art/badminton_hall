...
<script>
    $(document).ready(function() {
            ...
            $.ajax({
                ...
                success: function(data) {
                    if (data?.success) {
                        ...
                        toastr.error("Gagal memuat data metode pembayaran.");
                    }
                },
        ...
        $('.btn-delete').click(function() {
            const id = $(this).data('id');
            confirmDelete('Anda yakin ingin menghapus metode pembayaran?', function() {
                $.ajax({
                    ...
                    error: function(xhr, status, err) {
                        toastr.error("Gagal menghapus data: " + err);
                    }
                });
            });
        });

        // Jika belum punya confirmDelete, tambahkan ini:
