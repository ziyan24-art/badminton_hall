                ...
                <div class="col-md-4">
                    <div class="card">
                        ...
                        <div class="card-footer d-flex justify-content-between">
                            <a href="{{ route('admin.field.show', ['field' => $field->id]) }}" class="btn btn-primary btn-round w-100 mr-2">
...
<script>
    $(document).ready(function() {
        $('.btn-delete').click(function() {
            ...
            confirmDelete('Anda yakin ingin menghapus lapangan?', function() {
                $.ajax({
                    url: `{{ url('admin/master/field/delete') }}/${id}`,
